...
async def exchange_rates(message: Message):
   url = f"https://v6.exchangerate-api.com/v6/{EXCHANGE_API}/latest/USD"
   try:
...
async def send_tips(message: Message):
    financial_tips = [
        "1. Ведите учёт доходов и расходов — используйте приложения или таблицы, чтобы отслеживать, куда уходят деньги.",
        "2. Покупайте осознанно — сравнивайте цены, избегайте импульсивных трат, планируйте крупные покупки заранее.",
        "3. Откладывайте минимум 10% от дохода — создайте финансовую подушку безопасности и инвестируйте в долгосрочную перспективу."
    ]
